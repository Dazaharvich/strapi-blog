  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      ...
      <div className="mt-4">
        ...
        <p className="text-gray-600 mt-2">{blog.data.attributes.Descripcion}</p>
        <div className="mt-4 flex items-center text-gray-400">
          <span className="text-sm">Published on {""}{new Date(blog.data.attributes.plublishedAt).toLocaleString()}</span>
        </div>
      </div>
    </div>
  );
